...
exports.getScaffold = getScaffold;
exports.defaultColumnsForOutput = defaultColumnsForOutput;
 ...
 */
function defaultColumnsForOutput(outputType) {
    switch (outputType) {
 ...
 */
function resolveAction(editTools, preferredTypes) {
